...
// Dynamically import VersionHistory to avoid hydration issues
const VersionHistory = dynamic(() => import('./[id]/VersionHistory'), { 
  ssr: false,
  loading: () => <div className="text-sm text-gray-500">Loading version history...</div>
})
      ...
      {mounted && (
        <>
          {activeTab === 'released' ? (
            ...
            /* WIP Tab - Draft and In Approval versions */
            <div className="space-y-6">
              <Card>
                <CardHeader>
